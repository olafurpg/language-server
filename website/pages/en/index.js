...
const Features = props => {
  const features = [
    ...
    },
    {
      ...
      content:
        "Compile errors are published from the build tool, no more spurious red squiggles or switching focus to the console.",
    ...
    },
    {
      ...
      content:
        "Jump to symbol definitions in your project sources and external Scala/Java libraries.",
